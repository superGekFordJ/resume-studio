...
export interface AIActions {
  ...
  startSingleFieldImprovement: (payload: { uniqueFieldId: string; sectionId: string; itemId?: string; fieldId: string; currentValue: string; prompt: string; isPersonalDetails?: boolean; }) => Promise<void>;
