...
export const OpenSourceItemComponent = ({ item, roleMap }: OpenSourceItemComponentProps) => {
  ...
  return (
    <div className="py-1.5 px-3">
      ...
      <div className="flex flex-wrap mt-1 gap-x-4 gap-y-1 text-xs text-[#888888]">
        {urlField?.value && (
          <a href={urlField.value as string} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-[#3cb371]">
