...
export const VeridianTitledBlockComponent = ({ item, roleMap }: VeridianTitledBlockComponentProps) => {
  ...
  return (
    <div className="mb-4">
      ...
      {dateField?.value && (
        <p className="text-[12px] text-white/85 mb-2 font-sans">{dateField.value}</p>
      )}
